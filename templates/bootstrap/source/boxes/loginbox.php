<?php
  ...
  if (!isset($_SESSION['customer_id'])) {
    ...
    $box_smarty->assign('FIELD_EMAIL', xtc_draw_input_field('email_address', '', 'class="span11" maxlength="50"'));
    $box_smarty->assign('FIELD_PWD', xtc_draw_password_field('password', '', 'class="span11" maxlength="30"'));
