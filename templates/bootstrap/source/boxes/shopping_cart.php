<?php
  ...
  if (isset($_SESSION['customer_id'])) {
    ...
    if (isset($_SESSION['cc_id'])) {
      $box_smarty->assign('COUPON_HELP_LINK', '<a target="_blank" class="'.POPUP_COUPON_HELP_LINK_CLASS.'" title="Information" href="'.xtc_href_link(FILENAME_POPUP_COUPON_HELP, 'cID='.$_SESSION['cc_id']. '&KeepThis=true&TB_iframe=true&height=400&width=600', $request_type).'">Information</a>');
    }
  }
// Meine Änderung einheitlicher Link
    $box_smarty->assign('LINK_CART', '<a href="'.xtc_href_link(FILENAME_SHOPPING_CART, '', 'NONSSL').'">'.xtc_image_button('button_goto_cart.gif', NAVBAR_TITLE_SHOPPING_CART).'</a>');
