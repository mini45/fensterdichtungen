...
// Meine Änderung einheitlicher Link
      $box_smarty->assign('LINK_MORE','<br /><a href="' . xtc_href_link(FILENAME_DEFAULT, xtc_manufacturer_link($manufacturer['manufacturers_id'],$manufacturer['manufacturers_name'])) . '" >'.xtc_image_button('button_manufactors_info.gif', BOX_MANUFACTURER_INFO_OTHER_PRODUCTS). '</a>');
    }
  }
