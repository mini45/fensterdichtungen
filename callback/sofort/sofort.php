	...
	function _checkExistingSofortConstants($paymentMethod) {
		...
		if(!in_array($_SESSION['language'], $installedModulLangs)) {
			switch ($paymentMethod) {
				case 'SU': include_once('lang/english/modules/payment/sofort_sofortueberweisung.php'); break;
				case 'SV': include_once('lang/english/modules/payment/sofort_sofortvorkasse.php'); break;
				case 'SL': include_once('lang/english/modules/payment/sofort_sofortlastschrift.php'); break;
				case 'LS': include_once('lang/english/modules/payment/sofort_lastschrift.php'); break;
				case 'SR': include_once('lang/english/modules/payment/sofort_sofortrechnung.php'); break;
				default:
			}
		}
