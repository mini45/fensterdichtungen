...
function handleIdeal() {
	...
	if (function_exists('mysql_affected_rows') && mysql_affected_rows() == '1') HelperFunctions::insertHistoryEntry($orderId, HelperFunctions::getLastOrderStatus($orderId), MODULE_PAYMENT_SOFORT_MULTIPAY_TRANSACTION_ID.': '.$tId);
