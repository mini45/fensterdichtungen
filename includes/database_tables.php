...
/* -----------------------------------------------------------------------------------------
  ...
  define('TABLE_AGI_CATEGORIES_DESCRIPTION_ADD', 'agi_categories_description_add');
  define('TABLE_AGI_PRODUCTS_DESCRIPTION_ADD', 'agi_products_description_add');
  define('TABLE_AGI_PRODUCTS_ADD', 'agi_products_add');
  define('TABLE_AGI_PRODUCTS_IMAGES_TO_ATTRIBUTES', 'agi_products_images_to_attributes');
  /* EOF AGI GOOGLE-XML-EXPORT www.andreas-guder.de 1/1 */


  define('TABLE_T10_SEARCHSTATS', 't10_searchstats');
?>
