...
$smarty->assign('ORDER_CUSTID', $_SESSION['customer_id']);
$smarty->assign('ORDER_CURR', $order->info['currency']);
$smarty->assign('ORDER_MAIL', $order->customer['email_address']);
$smarty->assign('ORDER_PAYMENTTYPE', $order->info['payment_method']);
/* TRUSTED SHOPS ADDON END */
