...
define('AGI_GOOGLE_EXPORT_ALLOWED', 'Allow Google-Export?');
define('AGI_GOOGLE_ADWORDS_GROUPING', 'Adwords Grouping');
define('AGI_GOOGLE_ADWORDS_LABELS', 'Adwords Label');
define('AGI_GOOGLE_ADWORDS_REDIRECT', 'Adwords Redirection-URL');
define('AGI_GOOGLE_EXCLUDED_DESTINATION', 'Excludet of Google destination');
define('AGI_GOOGLE_MOBILE_LINK', 'Mobile-Link');
define('AGI_GOOGLE_EXPIRATION_DATE', 'Expire (YYYY-MM-DD)');
define('AGI_GOOGLE_ONLINE_ONLY', 'online only');
define('AGI_GOOGLE_CONDITION', 'condition');
define('AGI_GOOGLE_CATEGORY', 'Google-Category');
define('TEXT_GOOGLE_CONDITION_REFURBISHED', 'refurbished');
define('TEXT_GOOGLE_CONDITION_USED', 'used');
define('TEXT_GOOGLE_CONDITION_NEW', 'new');
define('AGI_GOOGLE_IDENTIFIER_EXISTS', 'identifier exists');
define('AGI_GOOGLE_PRODUCTS_BRAND', 'brand (alternative to manufacturer)');
define('AGI_GOOGLE_ENERGY_EFFICIENCY', 'energy efficiency');
define('AGI_GOOGLE_MULTIPACK_AMOUNT', 'multipack (amount)');
define('AGI_GOOGLE_ATTRIBUTE_CLOTHING_TITLE', 'Clothing');
define('AGI_GOOGLE_ATTRIBUTE_CLOTHING_DESC', 'Fillin the following attribute-fields only if the values are necessary for google-export and not been set by product-attributes, or if you want to overwrite the existing product-attributes for this article. Separate more than on value by semikolon.');
define('AGI_GOOGLE_ATTRIBUTE_COLOR', 'Attribute: Color');
define('AGI_GOOGLE_ATTRIBUTE_SIZE', 'Attribute: Size');
define('AGI_GOOGLE_ATTRIBUTE_PATTERN', 'Attribute: Pattern');
define('AGI_GOOGLE_ATTRIBUTE_MATERIAL', 'Attribute: Material');
define('AGI_GOOGLE_ATTRIBUTE_GENDER', 'Attribute: Gender');
define('AGI_GOOGLE_ATTRIBUTE_AGE_GROUP', 'Attribute: Age Group');
define('AGI_GOOGLE_ATTRIBUTE_GENDER_UNISEX', 'Unisex');
define('AGI_GOOGLE_ATTRIBUTE_GENDER_FEMALE', 'Female');
define('AGI_GOOGLE_ATTRIBUTE_GENDER_MALE', 'Male');
define('AGI_GOOGLE_ATTRIBUTE_AGE_GROUP_ADULT', 'Adult');
define('AGI_GOOGLE_ATTRIBUTE_AGE_GROUP_KIDS', 'Kids, up to 13 years');
define('AGI_GOOGLE_ATTRIBUTE_AGE_GROUP_NEWBORN', 'Newborn, up to 3 months');
define('AGI_GOOGLE_ATTRIBUTE_AGE_GROUP_INFANT', 'Infant, up to 12 months');
define('AGI_GOOGLE_ATTRIBUTE_AGE_GROUP_TODDLER', 'Toddler, up to 5 years');
define('AGI_GOOGLE_CATEGORY_DESC', 'Google-Categories will be passed by shops categories. Fill in the Google-Category here, if it is different to the Google-Category of the shops category');
define('AGI_GOOGLE_ALTERNATIVE_TITLE', 'different producttitle');
define('AGI_GOOGLE_CUSTOM_LABEL', 'Custom Label');
define('AGI_GOOGLE_ATTRIBUTE_SIZE_TYPE', 'Clothing: size-type');
define('AGI_GOOGLE_ATTRIBUTE_SIZE_SYSTEM', 'Clothing: size-system');
define('AGI_GOOGLE_ATTRIBUTE_SIZE_TYPE_REGULAR', 'regular');
define('AGI_GOOGLE_ATTRIBUTE_SIZE_TYPE_PETITE', 'petite');
define('AGI_GOOGLE_ATTRIBUTE_SIZE_TYPE_PLUS', 'plus');
define('AGI_GOOGLE_ATTRIBUTE_SIZE_TYPE_MATERNITY', 'maternity');
define('AGI_GOOGLE_ATTRIBUTE_SIZE_SYSTEM_DEFAULT', 'default');
define('AGI_NO_IMAGE_ATTRIBUTES', '');
define('AGI_ALL_IMAGE_ATTRIBUTES', 'all');
