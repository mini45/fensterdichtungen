...
define('TEXT_INFO_SHIPPING_STATUS_GOOGLE_STATUS', 'Google-Availability: ');
define('GOOGLE_STATUS_IN_STOCK', 'in stock');
define('GOOGLE_STATUS_AVAILABLE_FOR_ORDER', 'available for order');
define('GOOGLE_STATUS_OUT_OF_STOCK', 'out of stock');
define('GOOGLE_STATUS_PREORDER', 'preorder');
