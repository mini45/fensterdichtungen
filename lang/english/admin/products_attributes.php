...
define('AGI_TABLE_HEADING_GOOGLE_ATTRIBUT', 'matches the Google attribute');
define('AGI_GOOGLE_ATTRIBUTE_NO_ATTRIBUTE', 'no match');
define('AGI_GOOGLE_ATTRIBUTE_COLOR', 'color');
define('AGI_GOOGLE_ATTRIBUTE_SIZE', 'size');
define('AGI_GOOGLE_ATTRIBUTE_PATTERN', 'pattern');
define('AGI_GOOGLE_ATTRIBUTE_MATERIAL', 'material');
define('AGI_GOOGLE_ATTRIBUTE_GENDER', 'gender');
define('AGI_GOOGLE_ATTRIBUTE_AGE_GROUP', 'age-group');
