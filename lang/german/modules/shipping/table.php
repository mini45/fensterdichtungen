...
define('MODULE_SHIPPING_TABLE_TEXT_TITLE', 'Versandkosten Deutschland');
define('MODULE_SHIPPING_TABLE_TEXT_DESCRIPTION', 'Unsere Versandkosten für Sie');
define('MODULE_SHIPPING_TABLE_TEXT_WAY', 'DHL');
