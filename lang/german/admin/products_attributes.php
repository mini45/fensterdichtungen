...
define('AGI_TABLE_HEADING_GOOGLE_ATTRIBUT', 'entspricht dem Google-Attribut');
define('AGI_GOOGLE_ATTRIBUTE_NO_ATTRIBUTE', 'keine Auswahl');
define('AGI_GOOGLE_ATTRIBUTE_COLOR', 'Farbe');
define('AGI_GOOGLE_ATTRIBUTE_SIZE', 'Gr&ouml;&szlig;e');
define('AGI_GOOGLE_ATTRIBUTE_PATTERN', 'Muster');
define('AGI_GOOGLE_ATTRIBUTE_MATERIAL', 'Material');
define('AGI_GOOGLE_ATTRIBUTE_GENDER', 'Geschlecht');
define('AGI_GOOGLE_ATTRIBUTE_AGE_GROUP', 'Altersgruppe');
