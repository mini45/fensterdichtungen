...
define('TEXT_INFO_SHIPPING_STATUS_GOOGLE_STATUS', 'Google-Status: ');
define('GOOGLE_STATUS_IN_STOCK', 'auf lager');
define('GOOGLE_STATUS_AVAILABLE_FOR_ORDER', 'bestellbar');
define('GOOGLE_STATUS_OUT_OF_STOCK', 'vergriffen');
define('GOOGLE_STATUS_PREORDER', 'vorbestellt');
