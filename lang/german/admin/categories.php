...
define('AGI_GOOGLE_EXCLUDED_DESTINATION', 'ausgeschlossen von Google-Zielanwendung');
...
define('AGI_GOOGLE_ATTRIBUTE_CLOTHING_TITLE', 'Bekleidung');
define('AGI_GOOGLE_ATTRIBUTE_CLOTHING_DESC', 'F&uuml;llen Sie die nachfolgenden Attribut-Felder nur aus, wenn die Werte f&uuml;r den Google-Export notwendig sind und nicht bereits durch zugeordnete Attribute festgelegt sind, oder Sie abweichende Produktattribute exportieren m&ouml;chten. Mehrere Werte k&ouml;nnen durch Semikolon getrennt angegeben werden.');
define('AGI_GOOGLE_ATTRIBUTE_COLOR', 'Attribut: Farbe');
define('AGI_GOOGLE_ATTRIBUTE_SIZE', 'Attribut: Gr&ouml;&szlig;e');
define('AGI_GOOGLE_ATTRIBUTE_PATTERN', 'Attribut: Muster');
define('AGI_GOOGLE_ATTRIBUTE_MATERIAL', 'Attribut: Material');
define('AGI_GOOGLE_ATTRIBUTE_GENDER', 'Attribut: Geschlecht');
define('AGI_GOOGLE_ATTRIBUTE_AGE_GROUP', 'Attribut: Altersgruppe');
define('AGI_GOOGLE_ATTRIBUTE_GENDER_UNISEX', 'Unisex');
define('AGI_GOOGLE_ATTRIBUTE_GENDER_FEMALE', 'Damen');
define('AGI_GOOGLE_ATTRIBUTE_GENDER_MALE', 'Herren');
define('AGI_GOOGLE_ATTRIBUTE_AGE_GROUP_ADULT', 'Erwachsene');
define('AGI_GOOGLE_ATTRIBUTE_AGE_GROUP_KIDS', 'Kinder, bis 13 Jahre');
define('AGI_GOOGLE_ATTRIBUTE_AGE_GROUP_NEWBORN', 'Neugeborene, bis 3 Monate');
define('AGI_GOOGLE_ATTRIBUTE_AGE_GROUP_INFANT', 'S&auml;uglinge, 12 Monate');
define('AGI_GOOGLE_ATTRIBUTE_AGE_GROUP_TODDLER', 'Kleinkinder, bis 5 Jahre');
define('AGI_GOOGLE_CATEGORY_DESC', 'Google-Kategorien werden beim Erstellen der Exportdatei aus den Shopkategorien auf die Produkte vererbt. Geben Sie hier die Google-Kategorie an, wenn diese von der Google-Kategorie der Shopkategorie abweicht.');
define('AGI_GOOGLE_ALTERNATIVE_TITLE', 'abweichender Produkttitel');
define('AGI_GOOGLE_CUSTOM_LABEL', 'Benutzerdefinierte Label');
define('AGI_GOOGLE_ATTRIBUTE_SIZE_TYPE', 'Bekleidung: Gr&ouml;&szlig;entyp');
define('AGI_GOOGLE_ATTRIBUTE_SIZE_SYSTEM', 'Bekleidung: Gr&ouml;&szlig;ensystem');
define('AGI_GOOGLE_ATTRIBUTE_SIZE_TYPE_REGULAR', 'Normalgr&ouml;&szlig;e / regular');
define('AGI_GOOGLE_ATTRIBUTE_SIZE_TYPE_PETITE', 'Kurzgr&ouml;&szlig;e / petite');
define('AGI_GOOGLE_ATTRIBUTE_SIZE_TYPE_PLUS', 'gro&szlig;e Gr&ouml;&szlig;en / plus');
define('AGI_GOOGLE_ATTRIBUTE_SIZE_TYPE_MATERNITY', 'Umstandsgr&ouml;&szlig;e');
define('AGI_GOOGLE_ATTRIBUTE_SIZE_SYSTEM_DEFAULT', 'Standard');
define('AGI_NO_IMAGE_ATTRIBUTES', 'keine Auswahl');
define('AGI_ALL_IMAGE_ATTRIBUTES', 'Alle');
