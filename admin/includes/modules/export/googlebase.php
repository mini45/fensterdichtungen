...
class googlebase {
  ...
  function process($file = MODULE_GOOGLEBASE_FILE) {
    ...
    $schema_txt_de = "beschreibung".chr(9)."id".chr(9)."link".chr(9)."preis".chr(9)."w".chr(228)."hrung".chr(9)."titel".chr(9)."zustand".chr(9)."bild_url".chr(9)."ean".chr(9)."gewicht".chr(9)."marke".chr(9)."google_produktkategorie".chr(9)."product_type".chr(9)."identifier_exists".chr(9)."versand".chr(9)."zahlungsmethode".chr(9)."zahlungsrichtlinien".chr(9)."verf".chr(252)."gbarkeit".chr(13);
