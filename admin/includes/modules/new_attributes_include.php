...
//EOF - web28 - 2010-12-14 - NEW edit products attributes
  ...
  if ($matches) {
    while ($line = xtc_db_fetch_array($result)) {
      ...
      /* BOF AGI GOOGLE-XML-EXPORT www.andreas-guder.de 1/2 */
      echo '<td class="dataTableHeadingContent" style="width:150px" title="'.ATTR_VPE_VALUE_DESCRIPTION.'"><strong>'.ATTR_VPE_VALUE.'</strong></td>'. PHP_EOL;
      /* EOF AGI GOOGLE-XML-EXPORT www.andreas-guder.de 1/2 */
      echo '</tr>'. PHP_EOL;
      ...
      if ($matches2) {
        ...
        while ($line = xtc_db_fetch_array($result2)) {
          ...
          while($line = xtc_db_fetch_array($result3)) {
            ...
            echo '</td>'. PHP_EOL;
            /* BOF AGI GOOGLE-XML-EXPORT www.andreas-guder.de 2/2 */
            echo '<td class="main" align="left"><input type="text" name="' . $current_value_id . '_vpe_value" value="' . ((isset($attr_array['attributes_vpe_value']) && $attr_array['attributes_vpe_value'] <> 0) ? $attr_array['attributes_vpe_value'] : '') . '" size="5"></td>'. PHP_EOL;
            /* EOF AGI GOOGLE-XML-EXPORT www.andreas-guder.de 2/2 */
            echo '</tr>'. PHP_EOL;
