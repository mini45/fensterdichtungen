...
?>
                  <table border="0" cellspacing="0" cellpadding="2" class="option-table">
                    <tr>
                      <td colspan="5" class="pageHeading">&nbsp;<?php echo HEADING_TITLE_OPT; ?>&nbsp;                          
                    ...
                    <tr>
                      <td colspan="5" class="smallText"><?php echo $option_pages;?></td>
                    </tr>
                    <tr>
                      <td colspan="5"><?php echo xtc_black_line(); ?></td>
                    </tr>
                    <tr class="dataTableHeadingRow">
                      ...
                      <td class="dataTableHeadingContent">&nbsp;<?php echo AGI_TABLE_HEADING_GOOGLE_ATTRIBUT; ?>&nbsp;</td>
