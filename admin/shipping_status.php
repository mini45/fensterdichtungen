...
/* --------------------------------------------------------------
  ...
  switch ($_GET['action']) {
    ...
    case 'save':
      ...
      /* BOF AGI GOOGLE-XML-EXPORT www.andreas-guder.de 2/6 */
      ...
      /* EOF AGI GOOGLE-XML-EXPORT www.andreas-guder.de 2/6 */
      if ($_POST['default'] == 'on') {
...
<?php
  /* BOF AGI GOOGLE-XML-EXPORT www.andreas-guder.de 3/6 */
  ...
  $shipping_status_query_raw = "select shipping_status_id, shipping_status_name,shipping_status_image,google_status_name from " . TABLE_SHIPPING_STATUS . " where language_id = '" . $_SESSION['languages_id'] . "' order by shipping_status_id";
  /* EOF AGI GOOGLE-XML-EXPORT www.andreas-guder.de 3/6 */
...
<?php
  ...
  switch ($_GET['action']) {
    case 'new':
      ...
      /* BOF AGI GOOGLE-XML-EXPORT www.andreas-guder.de 4/6 */
      $contents[] = array('text' => '<br />' . TEXT_INFO_SHIPPING_STATUS_GOOGLE_STATUS . xtc_draw_pull_down_menu('google_status_name', $google_status_options, 'in stock'));
      /* EOF AGI GOOGLE-XML-EXPORT www.andreas-guder.de 4/6 */
    ...
    case 'edit':
      ...
      $contents[] = array('text' => '<br />' . TEXT_INFO_SHIPPING_STATUS_NAME . $shipping_status_inputs_string);
      /* BOF AGI GOOGLE-XML-EXPORT www.andreas-guder.de 5/6 */
      $contents[] = array('text' => '<br />' . TEXT_INFO_SHIPPING_STATUS_GOOGLE_STATUS . xtc_draw_pull_down_menu('google_status_name', $google_status_options, $oInfo->google_status_name));
      /* EOF AGI GOOGLE-XML-EXPORT www.andreas-guder.de 5/6 */
    ...
    default:
      if (is_object($oInfo)) {
        ...
        /* BOF AGI GOOGLE-XML-EXPORT www.andreas-guder.de 6/6 */
        $contents[] = array('text' => '<br />' . TEXT_INFO_SHIPPING_STATUS_GOOGLE_STATUS . $oInfo->google_status_name);
        /* EOF AGI GOOGLE-XML-EXPORT www.andreas-guder.de 6/6 */
      }
      break;
  }
